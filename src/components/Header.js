          ...
          <div className="bg-zinc-900/50 rounded-2xl p-6 border border-zinc-800">
            ...
            <div className="flex items-center gap-4 mb-5">
              ...
              <div className="ml-auto text-right">
                <p className="text-2xl font-bold text-white">{formatXP(leader.xp)}</p>
            ...
            {nextRankInfo ? (
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-zinc-300">{formatXP(nextRankInfo.xpNeeded)} XP needed</span>
                </div>
              ...
              <div className="text-center py-2">
                <span className="text-zinc-400 text-sm">Max rank achieved!</span>
              </div>
            )}
            ...
            <div className="mt-4 pt-4 border-t border-zinc-800">
              ...
              <p className="text-right text-xs text-zinc-600 mt-1">{progressPercent.toFixed(1)}%</p>
            </div>
          </div>
        </div>
      </div>
